...
//definizione del nodo di un BST
struct bstNode;

//definizione del dizionario come puntatore ad un nodo (radice)
typedef bstNode* Dictionary;

//definizione del puntatore nullo in un BST
const Dictionary emptyNode = nullptr;
...
#if !defined(USE_TREE) && !defined(USE_HASH_TABLE) && !defined(USE_ORDERED_LIST) && !defined(USE_ORDERED_VECTOR)
