...
void add_edge_from_line(movies::MovieDB &mdb, string line)
{
    ...
    if (!movies::addEdge(mdb, person, movie, t))
  ...
  while (true) {
    ...
    try  {
        ...
        switch (ch) {
            ...
            case 'b':
                success = movies::addVertex(mdb, label, movies::PERSON);
                break;
            
            case 'c':
                success = movies::addVertex(mdb, label, movies::MOVIE);
                break;
            ...
            case 'e':
                cout << movies::numNodesPerType(mdb, movies::PERSON) << endl;
                break;
            
            case 'f':
                cout << movies::numNodesPerType(mdb, movies::MOVIE) << endl;
                break;

            case 'g':
                cout << movies::numEdgesPerType(mdb, movies::ACTED) << endl;
                break;
            
            case 'h':
                cout << movies::numEdgesPerType(mdb, movies::DIRECTED) << endl;
                break;
            
            case 'i':
                cout << movies::numEdgesPerType(mdb, movies::PRODUCED) << endl;
                break;
